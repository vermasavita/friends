...
const Login = () => {
  ...
  return (
    <div className="w-full h-screen px-4 py-6 sm:px-0 flex flex-col justify-center bg-sky-50">
      <div className="w-2/5 py-3 sm:max-w-xl sm:w-10/12 mx-auto text-center md:w-96 flex justify-center">
        <div className="mt-4 bg-white w-3/4 shadow-md rounded-lg text-left">
          ...
          <div className="px-5 py-2 pb-7 sm:px-6">
            ...
            <div className="mt-5">
              <button
                className="font-semibold w-full mt-5 mb-3 bg-blue-400 text-white px-7 rounded-lg hover:bg-slate-300 hover:text-black  py-2"
                onClick={guestIptHandler}
              >
                Add Guest Credential
              </button>
              <button
                className="font-semibold w-full mb-4 bg-blue-400 text-white px-7 rounded-lg hover:bg-slate-300 hover:text-black py-2"
